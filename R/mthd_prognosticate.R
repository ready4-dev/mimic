    ...
    unlink_1L_lgl = TRUE, ...) 
{
    ...
    if (draws_1L_chr %in% c("make", "make_batch")) {
        author(X, consent_1L_chr = consent_1L_chr, consent_indcs_int = consent_indcs_int, 
            options_chr = options_chr, unlink_1L_lgl = T, what_1L_chr = "draws", 
    ...
    args_ls <- list(arms_chr = x@arms_chr, arms_tb = x@arms_tb, 
        ...
        horizon_dtm = x@horizon_dtm, inputs_ls = manufacture(x@x_MimicInputs, 
            what_1L_chr = "inputs_ls"), intervention_fn = x@x_MimicAlgorithms@main_ls$intervention_fn, 
