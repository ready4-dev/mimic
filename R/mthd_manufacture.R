...
#' @param what_1L_chr What (a character vector of length one), Default: c("draws_tb", "args_all", "daystonever", "iterations", "modifiable","outcomes", "population_ls", "resources", "utilities")
#' @param ... Additional arguments
#' @return Object (an output object of multiple potential types)
#' @rdname manufacture-methods
