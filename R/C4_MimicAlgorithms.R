...
slots = c(main_ls = "list",processing_ls = "list",sensitivities_ls = "list",transformations_ls = "list",dissemination_1L_chr = "character"),
prototype =  list(main_ls = make_simulation_fns_ls('main'),processing_ls = make_simulation_fns_ls('processing'),sensitivities_ls = make_simulation_fns_ls('sensitivity'),transformations_ls = make_simulation_fns_ls('transformation')))
