...
#' @param dir_1L_chr Directory (a character vector of length one)
#' @param drop_params_1L_lgl Drop parameters (a logical vector of length one), Default: FALSE
#' @param ratify_1L_lgl Ratify (a logical vector of length one), Default: FALSE
#' @param suffix_1L_chr Suffix (a character vector of length one), Default: ""
#' @param use_chr Use (a character vector), Default: character(0) 
#' @param Y_MimicRepos  (an instance of the MimicRepos class), Default: MimicRepos()
