...
#' @param event_1L_chr Event (a character vector of length one), Default: character(0)
...
methods::setMethod("renew", "MimicActive", function (x, batch_1L_int = integer(0), env_ls = list(), event_1L_chr = character(0), 
    type_1L_chr = c("trigger", "customise", "filter", "schedule"), 
    X_MimicConfiguration = MimicConfiguration(), ...) 
{
    type_1L_chr <- match.arg(type_1L_chr)
    if (!identical(event_1L_chr, character(0))) {
        X_MimicEvent <- procure(X_MimicConfiguration, target_1L_chr = event_1L_chr, 
            what_1L_chr = "event")
    }
    else {
    ...
    if (type_1L_chr == "customise") {
        if (!is.null(X_MimicConfiguration@x_MimicAlgorithms@processing_ls$customise_fn)) {
            args_ls <- update_arguments_ls(env_ls, function_fn = X_MimicConfiguration@x_MimicAlgorithms@processing_ls$customise_fn)
...
#' @importFrom rlang exec
#' @importFrom ready4 renew
methods::setMethod("renew", "MimicPopulation", function (x, batch_1L_int = integer(0), env_ls = list(), event_1L_chr = character(0), 
    population_ls = NULL, type_1L_chr = c("trigger", "customise", 
        "filter", "event", "reset", "schedule", "switch", "transform"), 
    use_1L_chr = "Y", what_1L_chr = character(0), X_MimicConfiguration = MimicConfiguration(), 
    ...) 
{
    type_1L_chr <- match.arg(type_1L_chr)
    if (!identical(event_1L_chr, character(0))) {
    ...
    if (type_1L_chr == "event") {
        x <- renew(x, batch_1L_int = batch_1L_int, env_ls = env_ls, 
            event_1L_chr = event_1L_chr, type_1L_chr = "filter", 
            X_MimicConfiguration = X_MimicConfiguration)
        x <- renew(x, batch_1L_int = batch_1L_int, env_ls = env_ls, 
            event_1L_chr = event_1L_chr, type_1L_chr = "schedule", 
            X_MimicConfiguration = X_MimicConfiguration)
        x <- renew(x, batch_1L_int = batch_1L_int, env_ls = env_ls, 
            event_1L_chr = event_1L_chr, type_1L_chr = "trigger", 
            X_MimicConfiguration = X_MimicConfiguration)
        x <- renew(x, batch_1L_int = batch_1L_int, env_ls = env_ls, 
            event_1L_chr = event_1L_chr, type_1L_chr = "reset", 
            X_MimicConfiguration = X_MimicConfiguration, what_1L_chr = "Y")
        x <- renew(x, batch_1L_int = batch_1L_int, env_ls = env_ls, 
            event_1L_chr = event_1L_chr, type_1L_chr = "reset", 
            X_MimicConfiguration = X_MimicConfiguration, what_1L_chr = "Z")
    }
    if (type_1L_chr %in% c("filter", "schedule", "trigger")) {
        if (nrow(x@x_MimicActive@x_Ready4useDyad@ds_tb) > 0) {
            ...
            X_MimicActive <- renew(x@x_MimicActive, batch_1L_int = batch_1L_int, 
                env_ls = env_ls, event_1L_chr = event_1L_chr, 
                type_1L_chr = type_1L_chr, X_MimicConfiguration = X_MimicConfiguration)
