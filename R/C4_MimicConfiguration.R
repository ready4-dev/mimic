...
slots = c(arms_tb = "tbl_df",drop_missing_1L_lgl = "logical",drop_suffix_1L_chr = "character",horizon_dtm = "Period",iterations_ls = "list",modifiable_chr = "character",prior_batches_1L_int = "integer",seed_1L_int = "integer",start_dtm = "POSIXt",x_MimicAlgorithms = "MimicAlgorithms",x_MimicInputs = "MimicInputs",x_MimicPopulation = "MimicPopulation",dissemination_1L_chr = "character"),
