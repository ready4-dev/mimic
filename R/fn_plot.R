...
#' @param colour_1L_chr Colour (a character vector of length one), Default: ready4use::get_colour_codes(2)[2]
...
#' @importFrom ggplot2 labs expand_limits
#' @keywords internal
plot_economic_results <- function (economic_results_ls, what_1L_chr, alpha_1L_dbl = 0.8, 
    colour_1L_chr = ready4use::get_colour_codes(2)[2], size_1L_dbl = 3, 
        ...
        "ceac", "evi"), x_limits_dbl = numeric(0), ...) 
{
    ...
    if (type_1L_chr == "ceac") {
        plot_plt <- BCEA::ceac.plot(data_xx, graph = "ggplot2", 
            currency = "$", line = list(color = colour_1L_chr), 
            title = title_1L_chr, ...)
    }
    if (type_1L_chr == "cep") {
        plot_plt <- BCEA::ceplane.plot(data_xx, graph = "ggplot2", 
            wtp = threshold_1L_dbl, currency = "$", point = list(color = colour_1L_chr, 
...
#' @param colors_chr Colors (a character vector), Default: ready4use::get_colour_codes()
...
#' @keywords internal
plot_regression <- function (regressions_ls, what_1L_chr, close_1L_lgl = TRUE, colors_chr = ready4use::get_colour_codes(), 
...
plot_test_scatter <- function (X_Ready4useDyad, collapse_1L_lgl = F, grouping_1L_chr = character(0), 
    new_1L_lgl = F, var_1L_chr, old_1L_chr = "Observed", type_1L_chr = c("Simulated", 
        "Predicted")) 
{
    type_1L_chr <- match.arg(type_1L_chr)
