...
add_project_2_cost_sa_2() is an Add function that updates an object by
adding new values to new or empty fields. Specifically, this function
implements an algorithm to add project 2 cost sensitivity analysis 2.
The function is called for its side effects and does not return a value.

## Usage

``` r
add_project_2_cost_sa_2(
  X_Ready4useDyad,
...
- suffix_1L_chr:
  ...
  Suffix (a character vector of length one), Default: '\_S2'
