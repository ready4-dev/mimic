...
make_project_2_results_synthesis() is a Make function that creates a new
R object. Specifically, this function implements an algorithm to make
project 2 results synthesis. The function is called for its side effects
and does not return a value.

## Usage

``` r
make_project_2_results_synthesis(
  inputs_ls,
  results_ls,
