...
add_projected_decay() is an Add function that updates an object by
adding new values to new or empty fields. Specifically, this function
implements an algorithm to add projected decay. The function is called
...
- proportion_1L_dbl:
  ...
  Proportion (a double vector of length one), Default: 1
