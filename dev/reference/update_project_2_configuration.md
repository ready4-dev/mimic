...
update_project_2_configuration() is an Update function that edits an
object, while preserving core object attributes. Specifically, this
function implements an algorithm to update project 2 configuration. The
function is called for its side effects and does not return a value.

## Usage

``` r
update_project_2_configuration(
