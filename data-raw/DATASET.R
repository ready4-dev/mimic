...
y <- ready4class::ready4class_constructor() %>%
  dplyr::bind_rows(ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE, 
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                ...
                                                                slots_ls = list("x_MimicActive", "y_Ready4useDyad", "z_Ready4useDyad") %>% list(), 
                                                                pt_ls = list("MimicActive","Ready4useDyad", "Ready4useDyad") %>% list(),
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                ...
                                                                parent_class_chr = "Ready4Module",
                                                                inc_clss_ls = list("MimicAlgorithms", "MimicArguments", "MimicEventsList", "MimicInputs", "MimicVariables") %>% list()),
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE, 
                                                                ...
                                                                pt_ls = list("logical","character","list","Date","character","character","character", "MimicArguments") %>% list(),
                                                                vals_ls = list(list(
                                                                  assert_1L_lgl = "FALSE",
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE, 
                                                                ...
                                                                pt_ls = list("logical", "character","list","character","character", "MimicArguments") %>% list(),
                                                                vals_ls = list(list(
                                                                  assert_1L_lgl = "FALSE",
