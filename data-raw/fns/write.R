write_batch <- function(batch_1L_int,
  ...
  draws_tb <- make_draws_tb(inputs_ls, iterations_int = iterations_int, 
                            ...
                            scale_1L_int = scale_1L_int, seed_1L_int = seed_1L_int + batch_1L_int)
  if (!is.null(intervention_fn)) {
    Y_Ready4useDyad <- intervention_fn(inputs_ls, add_logic_fn = add_logic_fn, 
                                       ...
                                       tx_duration_dtm = tx_duration_dtm, seed_1L_int = seed_1L_int + batch_1L_int, 
  ...
  saveRDS(output_ls, 
          paste0(write_to_1L_chr, "/SimBatch", batch_1L_int + prior_batches_1L_int, ".RDS"))
  message(paste0("Output saved as SimBatch", batch_1L_int + prior_batches_1L_int, ".RDS"))
}
    ...
    purrr::walk(~{
      ...
      element_ls %>% purrr::walk2(names(element_ls), ~{
        saveRDS(.x, paste0(path_to_private_1L_chr, divider_1L_chr, 
                           processed_dir_1L_chr, divider_1L_chr, "R", divider_1L_chr, type_1L_chr, 
                           divider_1L_chr, .y, ".RDS"))
      })
    })
}
