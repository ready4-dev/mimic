print_cmprsns <- function(data_xx,
  ...
  table_xx <- data_xx %>% 
    ready4show::print_in_format(output_type_1L_chr = output_type_1L_chr,
                                table_fns_ls = ready4show::make_table_fns_ls(html_table_fn = ready4show::make_table_fn("HTML", what_1L_chr = what_1L_chr),
