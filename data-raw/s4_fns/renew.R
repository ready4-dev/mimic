  ...
  if(what_1L_chr == "population"){
    if(type_1L_chr == "form"){
      population_ls <- add_enter_model_event(X_Ready4useDyad = X_MimicConfiguration@x_MimicInputs@y_Ready4useDyad, #inputs_ls$Synthetic_r4,
                                             ...
                                             tx_duration_dtm = procure(X_MimicConfiguration, match_value_xx = arm_1L_chr, empty_xx = NULL, target_1L_chr = "Treatment duration"),
      ...
      x <- renewSlot(x,"x_MimicPopulation",
                     ...
                     # renewSlot(x@x_MimicPopulation,"x_Ready4useDyad", population_ls$X_Ready4useDyad) %>%
